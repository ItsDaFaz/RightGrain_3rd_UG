...
$sql = "INSERT INTO addtools (uname, ucontact, uaddress,tool,tamount)
VALUES('$name2','$contact2', '$address2','$tool','$amount2' )";
...
<div class="mySlides w3-display-container w3-center">
    ...
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
        <h1>Nazrul Mia</h1>
        <p><h3>I need 1000tk cash to buy fertilizer</h3></p>
        <h1 class="w3-hide-small"></h1>
        <p><a href="donate.html" class="w3-button w3-black w3-padding-large w3-large">Donate</a></p>
    </div>
</div>
<div class="mySlides w3-display-container w3-center">
    <img src="farmer1.jpg" style="width:100%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
        <h1>Goni Mia</h1>
        <p><h3>I need a tractor for few days</h3></p>
        <h1 class="w3-hide-small"></h1>
        <p><a href="donate.html" class="w3-button w3-black w3-padding-large w3-large">Donate</a></p>
    </div>
</div>
...
<header class="bgimg w3-display-container " style="width:100%" id="home">
    ...
    <br>
    <br>
    <p><a href="./FindInfo/InfoMainP1.html" class="w3-button w3-large w3-transparent" style="margin-top: 38%; margin-left: 15%;border: 1px solid white">Find Information</a></p>
    <p><a href="findRightCrop2.php" class="w3-button w3-large w3-transparent" style="margin-top: -8%; margin-left: 70%;border: 1px solid white">Find Right Crop</a></p>
