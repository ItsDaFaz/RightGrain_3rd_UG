...
$query1 = "SELECT uname,ucontact,uaddress,tool,tamount FROM addtools ORDER BY t_id DESC";
...
<div class="w3-top w3-hide-small">
  ...
  <div class="w3-content">
    ...
    <div class="w3-row w3-center w3-border w3-border-dark-gray" >
      ...
      <a href="javascript:void(0)" onclick="openMenu(event, 'Tools');">
        <div class="w3-col s12 tablink w3-padding-large w3-hover-green">Donate Tools</div>
      </a>
    ...
    <div id="Tools" class="w3-container menu w3-padding-32 w3-white">
    ...
    <p class="w3-text-black" style="font-size: 100%"> 
      ...
      Contact: <?php echo $rows['ucontact'];?> <br>
      Address: <?php echo $rows['uaddress'];?> <br>
      Name of the tool: <?php echo $rows['tool'];?> <br>
      No. of tools: <?php echo $rows['tamount'];?> <br>
